package me.eldodebug.soar.ui.minimap.interfaces;
...
import me.eldodebug.soar.management.mods.impl.MinimapMod;
import me.eldodebug.soar.ui.minimap.XaeroMinimap;
import me.eldodebug.soar.ui.minimap.minimap.Minimap;
    ...
    public static void load() {
        InterfaceHandler.minimap = new Minimap(new Interface("gui.xaero_minimap", 128, 128) {
            ...
            public void drawInterface(final int width, final int height, final int scale, final float partial) {
                ...
                InterfaceHandler.mc.ingameGUI.drawTexturedModalRect(Soar.instance.modManager.getModByClass(MinimapMod.class).getX(), Soar.instance.modManager.getModByClass(MinimapMod.class).getY(), 0, 0, (int)((mapW / 2 + 1) / sizeFix), (int)((mapH / 2 + 1) / sizeFix));
